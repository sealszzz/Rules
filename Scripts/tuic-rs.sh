...
[ -n "$TUIC_TAG" ] || TUIC_TAG="$(get_release_tag "$APP_REPO" 2>/dev/null || true)"
[ -n "$TUIC_TAG" ] || { echo "FATAL: cannot detect tuic-rs tag" >&2; exit 1; }
  ...
  cat >"$APP_CONF_FILE" <<EOF
{
  ...
  "relay_udp_socket_recv_buffer": 262144,
  "relay_udp_socket_send_buffer": 262144,
  "quic_datagram_receive_buffer": 262144,
  "quic_datagram_send_buffer": 262144,
  "quic_send_window": 4194304,
  "quic_recv_window": 4194304,
  "quic_stream_recv_window": 524288,
